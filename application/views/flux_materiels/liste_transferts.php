...
<title>Listes Transferts Matériels</title>
</head>
                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Liste des Transferts Matériels</h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Liste <small>tous les transferts</small></h2>
                                ...
                                <div class="x_content">
                                    <div class="text-left">
                                        <a href="<?php echo base_url('index.php/entreeStockController'); ?>" class="btn btn-lg btn-primary">Nouvelle Entrée</a>
                                    </div>
                                    <table class="table">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <?php for ($i = 0; $i < count($transferts); $i++) { ?>
                                                <tr>
                                                    <th scope="row"></th>
                                                    <td><a href="#"><?php echo $transferts[$i]->getDateTransfertFormat(); ?></a></td>
                                                    <td><?php echo $transferts[$i]->getCommentaire(); ?></td>
                                                    <td>
                                                        <!--<div class="fa-hover col-md-3 col-sm-4 col-xs-12">-->
                                                        <a href="<?php echo base_url('index.php/transfertFluxMateriel/bon/' . $transferts[$i]->getId()); ?>"><i class="fa fa-file-pdf-o"></i> télécharger</a>
                                                        <!--</div>-->
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        ...
                                        <ul class="pagination">
                                            ...
                                            <?php } else { ?>
                                                <li class="paginate_button previous" id="datatable-checkbox_previous">
                                                    <a href="<?php echo base_url('index.php/transfertFluxMateriel/previousPage/' . $pagination->getFirst()); ?>" aria-controls="datatable-checkbox" data-dt-idx="0" tabindex="0">Previous</a>
                                                </li>
                                            <?php } ?>
                                            <?php for ($i = $pagination->getFirst(); $i < $pagination->getLast(); $i++) { ?>
                                                ...
                                                <li class="paginate_button">
                                                    <a href="<?php echo base_url('index.php/transfertFluxMateriel/page/' . $i); ?>" aria-controls="datatable-checkbox" data-dt-idx="1" tabindex="0"><?php echo $i; ?></a>
                                                </li>
                                            <?php } ?>
                                            ...
                                            <?php } else { ?> 
                                                <li class="paginate_button next" id="datatable-checkbox_next">
                                                    <a href="<?php echo base_url('index.php/transfertFluxMateriel/nextPage/' . $pagination->getLast()) ?>" aria-controls="datatable-checkbox" data-dt-idx="7" tabindex="0">Next</a>
                                                </li>
                                            <?php } ?>  
                                        </ul>
                                    </div>
