                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Liste <small>des bon d'entrées</small></h2>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php for ($i = 0; $i < count($entrees); $i++) { ?>
                                                <tr>
                                                    <th scope="row"></th>
                                                    <td><a href="#"><?php echo $entrees[$i]->getDateMvtFormatted(); ?></a></td>
                                                    <td><?php echo $entrees[$i]->getCommentaire(); ?></td>
                                                    <td>
                                                        <!--<div class="fa-hover col-md-3 col-sm-4 col-xs-12">-->
                                                        <a href="<?php echo base_url('index.php/entreeStockController/bon/' . $entrees[$i]->getId()); ?>"><i class="fa fa-file-pdf-o"></i> télécharger</a>
                                                        <!--</div>-->
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        ...
                                        <ul class="pagination">
                                            ...
                                            <?php } else { ?>
                                                <li class="paginate_button previous" id="datatable-checkbox_previous">
                                                    <a href="<?php echo base_url('index.php/entreeStockController/previousPage/' . $pagination->getFirst()); ?>" aria-controls="datatable-checkbox" data-dt-idx="0" tabindex="0">Previous</a>
                                                </li>
                                            <?php } ?>
                                            <?php for ($i = $pagination->getFirst(); $i < $pagination->getLast(); $i++) { ?>
                                                ...
                                                <li class="paginate_button">
                                                    <a href="<?php echo base_url('index.php/entreeStockController/page/' . $i); ?>" aria-controls="datatable-checkbox" data-dt-idx="1" tabindex="0"><?php echo $i; ?></a>
                                                </li>
                                            <?php } ?>
                                            ...
                                            <?php } else { ?> 
                                                <li class="paginate_button next" id="datatable-checkbox_next">
                                                    <a href="<?php echo base_url('index.php/entreeStockController/nextPage/' . $pagination->getLast()) ?>" aria-controls="datatable-checkbox" data-dt-idx="7" tabindex="0">Next</a>
                                                </li>
                                            <?php } ?>  
                                        </ul>
                                    </div>
